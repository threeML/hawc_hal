...
def test_on_point_source(roi, maptree, response, point_source_model, liff=False):

    fit_point_source(roi, maptree, response, point_source_model, liff=liff)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--liff", help="Use LIFF instead of HAL (for benchmarking)", action="store_true"
    )
    ...
    parser.add_argument(
        "--ra_roi", help="RA of center of ROI", type=float, default=def_ra_roi
    )
    parser.add_argument(
        "--dec_roi", help="Dec of center of ROI", type=float, default=def_dec_roi
    )
    parser.add_argument(
        "--data_radius", help="Radius of the data ROI", type=float, default=def_drad
    )
    parser.add_argument(
        "--model_radius", help="Radius of the model ROI", type=float, default=def_mrad
    )
    ...
    parser.add_argument(
        "--free_position",
        help="Use this to set the position free",
        action="store_true",
        default=False,
    )
