...
from hawc_hal.interpolation import fast_linear_interpolator
...
def test_fast_bilinear_interpolation():
    ...
    mfi = fast_linear_interpolator.FastBilinearInterpolation(data.shape, (new_coords[:, 0], new_coords[:, 1]))
